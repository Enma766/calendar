  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-6xl flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 bg-black/5 md:bg-black/30 backdrop-blur-sm md:backdrop-blur-xl border border-white/10 md:border-white/20 rounded-3xl p-4 md:p-6 shadow-none md:shadow-2xl">
